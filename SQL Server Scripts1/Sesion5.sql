...
SELECT ShipCountry, SUBSTRING(ShipCountry,3,3)AS 'Extracción'FROM Orders
GO
--FUNCION REPLACE 
...
DATEDIFF(yy,OrderDate,RequiredDate)AS 'Plazoaños' FROM Orders
GO
...
SELECT DATEADD(yy,30,GETDATE())--el dia de hoy mas 30 años

--FUNCIONES LOGICAS
--IIF : EVALUA UNA EXPRESIÓN Y RETORNA LO QUE SE LE

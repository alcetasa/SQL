...
FROM 'D:\CAPACITACIONES\2023\POWER BI\BUSINESS INTELLIGENCE CON POWER BI\Sesión 9\Datos\CE Tb_hechos.txt'
WITH (
    FIELDTERMINATOR = '\t',
    ROWTERMINATOR = '\n',
...
SELECT  Numero_Encuesta,Nivel_Estudio,
		...
		WHEN Nivel_Estudio=4 THEN '4.Superior Técnica'
...
SELECT  Numero_Encuesta,Nivel_Estudio,
		CASE Nivel_Estudio
			...
			WHEN 4 THEN '4.Superior Técnica'
			ELSE '5.Superior Universitario'
		END AS  Nivel_Estudio2
FROM T_Hechos
